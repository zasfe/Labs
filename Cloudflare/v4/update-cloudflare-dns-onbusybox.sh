...
# enable command: ip(/bin/ip), route(/bin/route)
# disable command: which(/bin/which), host
# install curl: wget https://github.com/moparisthebest/static-curl/releases/download/v7.80.0/curl-amd64 -O /bin/curl; chmod +x /bin/curl
