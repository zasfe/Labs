...
echo "[1/5] Creating custom data directory and setting permissions..."
mkdir -p "$PG_DATA_DIR"
...
# 4. 데이터베이스 클러스터 초기화
echo "[3/5] Initializing new database cluster at $PG_DATA_DIR..."
...
echo "[4/5] Configuring systemd override to point to the new data path..."
